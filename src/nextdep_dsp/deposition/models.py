...
from nextdep_dsp.deposition.enum import EMSubType, ExperimentType, FileType, Status
...
class Experiment:
    ...
    def __init__(
        self,
        exp_type: Union[ExperimentType, str],
    ...
    @property
    def related_emdb(self) -> Optional[str]:
        return self._related_emdb

    @property
    def related_bmrb(self) -> Optional[str]:
...
class Depositor:
    ...
    @property
    def date_joined(self) -> Optional[datetime]:
